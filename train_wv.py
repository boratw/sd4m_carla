        ...
        for exp in range(1, 1000001):
            ...
            for task in range(task_num):
                ...
                for actor in vehicles_list:
                    ...
                    states.append([vx, vy, ax, ay, tr.rotation.roll, tr.rotation.pitch, 0., 0.])
                ...
                for step in range(500):
                    ...
                    for i, actor in enumerate(vehicles_list):
                        ...
                        vx, vy = rotate(v.x, v.y, yawsin, yawcos)
                        ax, ay = rotate(a.x, a.y, yawsin, yawcos)
                        nextstates.append([vx, vy, ax, ay, tr.rotation.roll, tr.rotation.pitch, actions[i][0], actions[i][1]])
                ...
                for iter2 in range(32):
                    for task in range(task_num):
                        if len(history_policy[task]) > explorer_batch:
                            ...
                            explorer[task].optimize_batch(state_dic, nextstate_dic, action_dic, goal_dic, reward_dic, survive_dic, exp)
                for task in range(task_num):
