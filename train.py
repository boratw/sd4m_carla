...
try:
    with sess.as_default():
        ...
        blueprints = [x for x in blueprints if
                        x.id == 'vehicle.mini.cooper_s' or
                        x.id == 'vehicle.lincoln.mkz_2017' or
                        x.id == 'vehicle.volkswagen.t2']
            ...
            for task in range(task_num):
                ...
                for x in range(8):
                    for y in range(8):
                        ...
                        spawn_point = carla.Transform(carla.Location(x * 200. - 800., y * 200. - 800., 1.0))
                ...
                for step in range(500):
                    ...
                    if step % traj_len == 0:
                        if (step // traj_len) % latent_preserve == 0:
                            desired_num = len(history_learner[task]) // 512
