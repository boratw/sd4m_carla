...
class Skill_Learner:
    def __init__(self, state_len, action_len, goal_len,  traj_len, latent_len, latent_body_len, task_num, name="",
        ...
        with tf.variable_scope(self.name): 
            ...
            self.input_body_traj = tf.placeholder(tf.float32, [None, traj_len, goal_len], name="input_body_traj")
            ...
            body_batched = tf.reshape(self.input_body_traj, [-1, traj_len * goal_len])
            ...
            with tf.variable_scope("Learner"):
                self.learner_encoder_body = GaussianEncoder("learner_encoder_body", traj_len * goal_len, latent_body_len, encoder_body_hidden_len, hidden_nonlinearity=vae_hidden_nonlinearity,
                ...
                self.learner_decoder_body = GaussianDistribution("learner_decoder_body", latent_body_len,  traj_len * goal_len, decoder_body_hidden_len, hidden_nonlinearity=vae_hidden_nonlinearity,
                    input_tensor=self.input_latent_body)
                self.learner_encoded_decoder_body = GaussianDistribution("learner_decoder_body", latent_body_len, traj_len * goal_len, decoder_body_hidden_len, hidden_nonlinearity=vae_hidden_nonlinearity,
                    input_tensor=encoded_latent_body, reuse=True)
                self.learner_latent_decoder_body = GaussianDistribution("learner_decoder_body", latent_body_len, traj_len * goal_len, decoder_body_hidden_len, hidden_nonlinearity=vae_hidden_nonlinearity,
                ...
                self.learner_output_discrete_body = tf.reshape(self.learner_decoder_body.mu, [-1, traj_len, goal_len])
                self.learner_output_discrete_action = self.learner_decoder_action.mu
                self.learner_output_stochastic_body = tf.reshape(self.learner_decoder_body.reparameterized, [-1, traj_len, goal_len])
            ...
            with tf.variable_scope("Sampler"):
                self.sampler = GaussianDistribution("sampler", latent_body_len, traj_len * goal_len, decoder_body_hidden_len, hidden_nonlinearity=vae_hidden_nonlinearity,
                    input_tensor=self.input_latent_body)
                self.sampled_sampler = GaussianDistribution("sampler", latent_body_len, traj_len * goal_len, decoder_body_hidden_len, hidden_nonlinearity=vae_hidden_nonlinearity,reuse=True,
                    input_tensor=sampling_latent)
                self.sampler_output_discrete = tf.reshape(self.sampler.mu, [-1, traj_len, goal_len])
                self.sampler_output_stochastic = tf.reshape(self.sampler.reparameterized, [-1, traj_len, goal_len])
                random_input = tf.random.normal([batch_size * random_batch, latent_body_len])
                self.random_sampler = GaussianDistribution("sampler", latent_body_len, traj_len * goal_len, decoder_body_hidden_len, hidden_nonlinearity=vae_hidden_nonlinearity,reuse=True,
                ...
                sampler_sampled_output = tf.reshape(self.sampled_sampler.reparameterized, [-1, traj_len, goal_len])
